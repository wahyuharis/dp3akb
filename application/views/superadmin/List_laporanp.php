...
<script type="text/javascript">
	...
	function hapus_laporan(id) {
		if (confirm('Apakah Anda yakin menghapus data ini?')) {
			...
			$.ajax({
				url: "<?php echo site_url('superadmin/perempuan/ajax_delete') ?>/" + id,
				type: "POST",
				dataType: "JSON",
	...
	function update_laporan(id) {
		...
		$.ajax({
			url: "<?php echo site_url('superadmin/perempuan/ajax_edit/') ?>/" + id,
			type: "GET",
			dataType: "JSON",
			success: function(data) {
	...
	function up_status() {
		...
		if (save_method == 'upstatus') {
			url = "<?php echo site_url('superadmin/perempuan/ajax_upstatus') ?>";
		}
	...
	function lihat_laporan(data) {
		window.location.href = "<?php echo base_url() ?>superadmin/perempuan/lihat_detail/" + data;
	}
</script>
