			...
			<form action="<?php echo site_url('superadmin/pengguna/update') ?>" method="post">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="level" id="level" class="form-control" tabindex="2">
								<option value="<?php echo $pengguna->level ?>"><?php echo $pengguna->level ?></option>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							<label>Jabatan</label>
							<input class="form-control" type="text" name="jabatan" id="jabatan" value="<?php echo $pengguna->jabatan ?>" tabindex="5">
